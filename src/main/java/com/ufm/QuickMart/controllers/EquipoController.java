...
public class EquipoController {
    ...
    @GetMapping("/torneo/{torneoId}")
    public ResponseEntity<List<Equipo>> obtenerEquiposPorTorneo(@PathVariable String torneoId) {
        List<Equipo> equipos = equipoService.obtenerEquiposPorTorneoId(torneoId);
        return ResponseEntity.ok(equipos);
    }
}
